...
class UIBuilder:
        ...
        with world_controls_frame:
            with ui.VStack(style=get_style(), spacing=5, height=0):
                self._load_btn = LoadButton(
                    "Load ur10e", "LOAD ur10e", setup_scene_fn=self._setup_scene, setup_post_load_fn=self._setup_scenario
                )
                self._load_btn.set_world_settings(physics_dt=1 / 60.0, rendering_dt=1 / 60.0)
                self.wrapped_ui_elements.append(self._load_btn)

                self._load_btn = LoadButton(
                    "Load Jaka", "LOAD jaka", setup_scene_fn=self._setup_scene_jaka, setup_post_load_fn=self._setup_scenario
                )
                self._load_btn.set_world_settings(physics_dt=1 / 60.0, rendering_dt=1 / 60.0)
                self.wrapped_ui_elements.append(self._load_btn)
    ...
    def _setup_scene(self):
        ...
        print("Loading ur10e")
        print(f"Assets root path: {get_assets_root_path()}")
        # robot_prim_path = "/jaka"
        # path_to_robot_usd = "D:/nv/articulation_inspector/minicobo_v14"
        # print("Loading Jaka ")
    ...
    def _setup_scene_jaka(self):
        ...
        # path_to_robot_usd = "d:/nv/articulation_inspector/minicobo_v14/minicobo_blue_1.usda"
