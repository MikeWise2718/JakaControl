...
class MatMan():
    ...
    def CreateMaterials(self):
        ...
        self.SetupMaterial("Yellow_Glass", "mtl", "Base/Glass/Glass_Clear_Saturated_Yellow")
        self.SetupMaterial("Purple_Glass", "mtl", "Base/Glass/Glass_Clear_Saturated_Purple")
        self.SetupMaterial("Cyan_Glass", "mtl", "Base/Glass/Glass_Clear_Saturated_Sea_Blue")
