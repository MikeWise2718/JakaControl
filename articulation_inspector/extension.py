...
class Extension(omni.ext.IExt):
    ...
    async def send_positions_by_websocket(self,uri):
    ...
    async def send_action(self,action,uri):
        async with websockets.connect(uri) as websocket:
            robot_name_split = self._selected_prim_path.split("/")
            current_time_str = datetime.now ().strftime ('%Y-%m-%d %H:%M:%S')
        ...
        with frame:
            with ui.VStack(style=get_style(), spacing=5, height=0):
                ...
                with ui.HStack():
                    ...
                    ui.Button("Send Position", clicked_fn=lambda: asyncio.ensure_future(self.send_positions_by_websocket('ws://integrationhubwebsocket.azurewebsites.net/67')))
                ...
                with ui.HStack():
                    ...
                    ui.Button("Take Photo", clicked_fn=lambda: asyncio.ensure_future(self.send_action('takephoto','ws://integrationhubwebsocket.azurewebsites.net/67')))
                ...
                with ui.HStack():
                    ...
                    ui.Button("Grab Phone", clicked_fn=lambda: asyncio.ensure_future(self.send_action('grabphone','ws://integrationhubwebsocket.azurewebsites.net/67')))
                ...
                with ui.HStack():
                    ...
                    ui.Button("Grab Camera", clicked_fn=lambda: asyncio.ensure_future(self.send_action('grabcamera','ws://integrationhubwebsocket.azurewebsites.net/67')))
